...
export default function Home() {
  ...
  return (<main className="bg-[#0f172a]">
    {/* SECTION 1: HERO  */}
    <section className="relative py-6 bg-[#0f172a] flex items-center justify-center px-4 overflow-hidden">
      ...
      <motion.div
        ...
        initial="hidden"
        animate="visible"
        className="relative z-10 backdrop-blur-md bg-white/5 border border-white/10 p-8 md:p-12 rounded-3xl shadow-2xl max-w-2xl w-full flex flex-col items-center"
      >
        ...
        <motion.h1
          variants={itemVariants}
          className="text-4xl md:text-6xl font-extrabold tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-white to-slate-400 mb-3"
        >
    ...
    {/* Final CTA Section */}
    <section className="py-32 px-6 text-center bg-gradient-to-t from-cyan-950/20 to-transparent">
      <motion.div
